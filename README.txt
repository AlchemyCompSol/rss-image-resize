...
3. Select `rss-image-resize.zip` from your computer
4. Click 'Install Now'
5. Activate the plugin in the Plugin dashboard

= Using FTP =

1. Download `rss-image-resize.zip`
...
Once you have activated the plugin, you can go to Settings --> RSS Image Resize to set the maximum width of your images.  The default is 500px.
